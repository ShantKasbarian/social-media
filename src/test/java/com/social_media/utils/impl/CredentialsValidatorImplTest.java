...
class CredentialsValidatorImplTest {
  ...
  @InjectMocks private CredentialsValidatorImpl credentialsValidator;

  @Mock private UsernameValidatorImpl usernameValidator;

  @Mock private EmailValidatorImpl emailValidator;
  ...
  void validateUserCredentialsShouldThrowInvalidInputExceptionWhenPasswordIsInvalid() {
    ...
    assertThrows(
        InvalidInputException.class,
        () -> credentialsValidator.validateUserCredentials(USERNAME, EMAIL, INVALID_PASSWORD));
  }
}
